...
#define LCD_LANGUAGE PRINTER_LCD_LANGUAGE
#define DISPLAY_CHARSET_HD44780 PRINTER_DISPLAY_CHARSET_HD44780
#define LCD_INFO_SCREEN_STYLE PRINTER_LCD_INFO_SCREEN_STYLE

#if ENABLED(PRINTER_SD)
    #define SDSUPPORT
#endif

#if ENABLED(PRINTER_SD_CHECK_AND_RETRY)
    #define SD_CHECK_AND_RETRY
#endif

#define SPI_SPEED PRINTER_SPI_SPEED

#if ENABLED(PRINTER_NO_LCD_MENUS)
    #define NO_LCD_MENUS
#endif

#if ENABLED(PRINTER_SLIM_LCD_MENUS)
    #define SLIM_LCD_MENUS
#endif

#if PRINTER_ENCODER_STEPS_PER_MENU_ITEM > 0
    #define ENCODER_STEPS_PER_MENU_ITEM PRINTER_ENCODER_STEPS_PER_MENU_ITEM
#endif

#if ENABLED(PRINTER_REVERSE_ENCODER_DIRECTION)
    #define REVERSE_ENCODER_DIRECTION 
#endif

#if ENABLED(PRINTER_REVERSE_MENU_DIRECTION)
    #define REVERSE_MENU_DIRECTION 
#endif

#if ENABLED(PRINTER_REVERSE_SELECT_DIRECTION)
    #define REVERSE_SELECT_DIRECTION
#endif

#if ENABLED(PRINTER_INDIVIDUAL_AXIS_HOMING_MENU)
    #define INDIVIDUAL_AXIS_HOMING_MENU
#endif

#if ENABLED(PRINTER_SPEAKER)
    #define SPEAKER
#endif

#if PRINTER_LCD_FEEDBACK_FREQUENCY_DURATION_MS > 0
    #define LCD_FEEDBACK_FREQUENCY_DURATION_MS PRINTER_LCD_FEEDBACK_FREQUENCY_DURATION_MS
#endif

#if PRINTER_LCD_FEEDBACK_FREQUENCY_HZ
    #define LCD_FEEDBACK_FREQUENCY_HZ PRINTER_LCD_FEEDBACK_FREQUENCY_HZ
#endif
...
#if ENABLED(NOZZLE_CLEAN_ENABLE_WIPE_SEQUENCE_COMMANDS)
    #define WIPE_SEQUENCE_COMMANDS NOZZLE_CLEAN_WIPE_SEQUENCE_COMMANDS
#endif

#if ENABLED(PRINTER_JOB_TIMER_AUTOSTART)
    #define PRINTJOB_TIMER_AUTOSTART
#endif

#if ENABLED(PRINTER_COUNTER)
    #define PRINTCOUNTER
#endif